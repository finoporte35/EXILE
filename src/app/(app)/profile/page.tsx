...
import { ImageUp, TrendingUp, Activity, User, Sparkles, Minus, ChevronsUp } from 'lucide-react';
...
// Stats updated to match the image, including values and new indicatorClass
const stats = [
  { name: "Overall", value: 38, Icon: TrendingUp, indicatorClass: "bg-gradient-to-r from-red-600 to-red-800" },
  { name: "Potential", value: 91, Icon: Activity, indicatorClass: "bg-gradient-to-r from-green-400 to-green-600" },
  { name: "Masculinity", value: 42, Icon: User, indicatorClass: "bg-gradient-to-r from-red-600 to-red-800" },
  { name: "Skin quality", value: 57, Icon: Sparkles, indicatorClass: "bg-gradient-to-r from-orange-400 to-orange-600" },
  { name: "Jawline", value: 31, Icon: Minus, indicatorClass: "bg-gradient-to-r from-red-600 to-red-800" },
  { name: "Cheekbones", value: 33, Icon: ChevronsUp, indicatorClass: "bg-gradient-to-r from-red-600 to-red-800" },
];
...
const StatItem: React.FC<StatItemProps> = ({ name, value, Icon, indicatorClass }) => (
  <div className="text-center">
    ...
    {/* Progress bar height increased to h-2 and uses indicatorClass */}
        ...
        <CardContent className="p-0">
          <div className="flex flex-col items-center mb-6">
            <Avatar className="h-24 w-24 mb-3 border-2 border-primary">
              {/* <AvatarImage src="https://placehold.co/100x100.png" alt={userProfile.name} /> */}
          ...
          <div>
            ...
            <Progress value={userProfile.rankProgressPercent} className="h-2 bg-muted mb-1" indicatorClassName="bg-primary" />
